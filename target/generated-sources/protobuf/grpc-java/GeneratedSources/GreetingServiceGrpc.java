...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "GeneratedSources.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<GeneratedSources.GreetingServiceOuterClass.HelloRequest,
      GeneratedSources.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = GeneratedSources.GreetingServiceOuterClass.HelloRequest.class,
      responseType = GeneratedSources.GreetingServiceOuterClass.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<GeneratedSources.GreetingServiceOuterClass.HelloRequest,
      GeneratedSources.GreetingServiceOuterClass.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<GeneratedSources.GreetingServiceOuterClass.HelloRequest, GeneratedSources.GreetingServiceOuterClass.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<GeneratedSources.GreetingServiceOuterClass.HelloRequest, GeneratedSources.GreetingServiceOuterClass.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  GeneratedSources.GreetingServiceOuterClass.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  GeneratedSources.GreetingServiceOuterClass.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(GeneratedSources.GreetingServiceOuterClass.HelloRequest request,
        io.grpc.stub.StreamObserver<GeneratedSources.GreetingServiceOuterClass.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                GeneratedSources.GreetingServiceOuterClass.HelloRequest,
                GeneratedSources.GreetingServiceOuterClass.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public GeneratedSources.GreetingServiceOuterClass.HelloResponse greeting(GeneratedSources.GreetingServiceOuterClass.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<GeneratedSources.GreetingServiceOuterClass.HelloResponse> greeting(
        GeneratedSources.GreetingServiceOuterClass.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((GeneratedSources.GreetingServiceOuterClass.HelloRequest) request,
              (io.grpc.stub.StreamObserver<GeneratedSources.GreetingServiceOuterClass.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return GeneratedSources.GreetingServiceOuterClass.getDescriptor();
    }
