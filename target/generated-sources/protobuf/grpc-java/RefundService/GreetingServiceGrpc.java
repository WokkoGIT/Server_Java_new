...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "RefundService.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<RefundService.RefundServiceOuterClass.HelloRequest,
      RefundService.RefundServiceOuterClass.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = RefundService.RefundServiceOuterClass.HelloRequest.class,
      responseType = RefundService.RefundServiceOuterClass.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<RefundService.RefundServiceOuterClass.HelloRequest,
      RefundService.RefundServiceOuterClass.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<RefundService.RefundServiceOuterClass.HelloRequest, RefundService.RefundServiceOuterClass.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<RefundService.RefundServiceOuterClass.HelloRequest, RefundService.RefundServiceOuterClass.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RefundService.RefundServiceOuterClass.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RefundService.RefundServiceOuterClass.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(RefundService.RefundServiceOuterClass.HelloRequest request,
        io.grpc.stub.StreamObserver<RefundService.RefundServiceOuterClass.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                RefundService.RefundServiceOuterClass.HelloRequest,
                RefundService.RefundServiceOuterClass.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public RefundService.RefundServiceOuterClass.HelloResponse greeting(RefundService.RefundServiceOuterClass.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<RefundService.RefundServiceOuterClass.HelloResponse> greeting(
        RefundService.RefundServiceOuterClass.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((RefundService.RefundServiceOuterClass.HelloRequest) request,
              (io.grpc.stub.StreamObserver<RefundService.RefundServiceOuterClass.HelloResponse>) responseObserver);
          break;
        default:
